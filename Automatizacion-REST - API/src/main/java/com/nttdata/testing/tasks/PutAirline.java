...
public class PutAirline implements Task {
    ...
    public static Performable withData(String _id, String name, String country, String logo, String slogan, String head_quaters, String website, String established) {
